...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(sa.text('DROP INDEX IF EXISTS ix_medications_id'))
    op.drop_table('medications')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_conditions_id'))
    op.drop_table('conditions')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_patient_dashboards_id'))
    op.drop_table('patient_dashboards')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_notifications_id'))
    op.drop_table('notifications')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_medical_records_id'))
    op.drop_table('medical_records')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_doctor_access_id'))
    ...
    op.execute(sa.text('DROP INDEX IF EXISTS ix_audit_logs_id'))
    op.drop_table('audit_logs')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_allergies_id'))
    op.drop_table('allergies')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_ai_summaries_id'))
    op.drop_table('ai_summaries')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_patients_id'))
    op.execute(sa.text('DROP INDEX IF EXISTS ix_patients_hospyn_id'))
    op.drop_table('patients')
    op.execute(sa.text('DROP INDEX IF EXISTS ix_doctors_id'))
