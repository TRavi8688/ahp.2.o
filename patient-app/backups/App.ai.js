...
export default function App() {
    ...
    useEffect(() => {
        // Force show after 3 seconds even if fonts aren't ready
    ...
    if (!fontsLoaded && !forceShow) {
        return (
            <View style={{ flex: 1, backgroundColor: '#050810', justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ color: '#FFFFFF', fontSize: 32, letterSpacing: 8, fontWeight: 'bold' }}>MULAJNA</Text>
                <Text style={{ color: '#6366F1', fontSize: 10, marginTop: 10, letterSpacing: 4 }}>SYSTEM OPTIMIZING...</Text>
            </View>
        );
    }
