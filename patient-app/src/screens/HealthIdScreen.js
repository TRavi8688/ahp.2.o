    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={{ padding: 24, alignItems: 'center' }}>
            ...
            >
                ...
                <View style={styles.patientInfo}>
                    <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.infoValue}>{profile?.full_name?.toUpperCase() || 'ANONYMOUS PATIENT'}</Text>
                    </View>
                    <View style={{ alignItems: 'flex-end', flex: 1 }}>
                        ...
                        <TouchableOpacity onPress={copyToClipboard} style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                            <Text style={styles.infoValue}>{profile?.hospyn_id || 'PENDING'}</Text>
            ...
            <View style={styles.actions}>
                ...
                <TouchableOpacity style={styles.actionBtn} onPress={() => Alert.alert('Share', 'Secure link sharing is active.')}>
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: '900', color: '#0f172a', marginTop: 20 },
    subtitle: { fontSize: 14, color: '#64748b', textAlign: 'center', marginTop: 8, marginBottom: 32, lineHeight: 20 },
    card: { width: '100%', borderRadius: 32, padding: 24, elevation: 15, shadowColor: '#4c1d95', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.4, shadowRadius: 20 },
    ...
    cardType: { color: 'rgba(255,255,255,0.6)', fontSize: 10, fontWeight: '700', letterSpacing: 1 },
    ...
    scanText: { color: 'rgba(255,255,255,0.6)', fontSize: 10, fontWeight: 'bold', letterSpacing: 0.5 },
    patientInfo: { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 20, marginBottom: 20 },
    infoLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 9, fontWeight: 'bold', marginBottom: 4 },
    infoValue: { color: '#fff', fontSize: 15, fontWeight: 'bold' },
    cardFooter: { alignItems: 'center' },
    securityText: { color: 'rgba(255,255,255,0.4)', fontSize: 8, fontWeight: 'bold', letterSpacing: 1 },
    actions: { flexDirection: 'row', gap: 12, marginTop: 32 },
    actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', paddingVertical: 14, borderRadius: 16, gap: 8, borderWidth: 1, borderColor: '#e2e8f0' },
    actionBtnText: { color: '#4c1d95', fontSize: 14, fontWeight: 'bold' },
    infoBox: { flexDirection: 'row', backgroundColor: '#f1f5f9', padding: 16, borderRadius: 16, marginTop: 32, gap: 12 },
    infoBoxText: { flex: 1, color: '#64748b', fontSize: 12, lineHeight: 18 }
});
